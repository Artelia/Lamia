...
class QtDesignerForm extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(url).then(response => {
            console.log('po', this.parseForm(response.data))
    ...
    renderLayout = (layout, values, updateField, nametransform = (name) => name) => {
        this.debugform ? console.log('renderLayout', layout) : null
        // console.log('renderLayout', layout)
        console.log('renderLayout', values)
    ...
    renderWidget = (widget, values, updateField, nametransform = (name) => name) => {
        this.debugform ? console.log('renderWidget', widget.name, widget.class) : null
        ...
        if (widget.class === "QLabel") {
            ...
            this.debugform ? console.log(widget.widget) : null
            // let rows=[]
            // for (const subwidget of widget.widget){
            //     console.log(subwidget);
            //     rows.push(this.renderWidget(subwidget, values, updateField, nametransform))
            // }
            return (
                <div>
                    {this.renderWidget(widget.widget[0], values, updateField, nametransform)}
                </div>
            )
