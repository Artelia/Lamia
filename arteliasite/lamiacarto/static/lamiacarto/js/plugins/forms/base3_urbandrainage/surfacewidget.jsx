...
class SurfaceEditingFormReact extends EditingFormReact {

    static firstdir = 'Assets'
    static label = 'Surfaces'
    table = 'surface'
    ...
    constructor(props) {
        ...
        this.state = {
            'currentlayer': '',
            'currentfeatprop': {},
            'formui': ':/forms/base3_urbandrainage/qgswidgets/lamia_form_surface_ui.ui',
            ...this.state
        }
...
module.exports = SurfaceEditingFormReact;