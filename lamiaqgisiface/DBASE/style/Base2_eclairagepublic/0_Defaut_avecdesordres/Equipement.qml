...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="pk_equipement">
    ...
    <edittype widgetv2type="TextEdit" name="dep_nom">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="dep_foncall">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="dep_typprot">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="dep_calprot">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="dep_diffdj">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="dep_neutsec">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_codlant">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_typelum">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_marque">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_ref">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_classe">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_couleur">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_hautfeu">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_typevas">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_typapp">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_famlamp">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fo_puilamp">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 attr="categorie" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="false" symbol="0" value="DEP" label="DEP"/>
      <category render="true" symbol="1" value="FOY" label="FOY"/>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="110,161,121,255"/>
  ...
  <aliases>
    <alias field="pk_equipement" index="0" name=""/>
    <alias field="id_equipement" index="1" name=""/>
    <alias field="lpk_descriptionsystem" index="2" name=""/>
    <alias field="categorie" index="3" name=""/>
    <alias field="lid_ressource_1" index="4" name=""/>
    <alias field="lid_descriptionsystem_1" index="5" name=""/>
    <alias field="dep_nom" index="6" name=""/>
    <alias field="dep_foncall" index="7" name=""/>
    <alias field="dep_typprot" index="8" name=""/>
    <alias field="dep_calprot" index="9" name=""/>
    <alias field="dep_diffdj" index="10" name=""/>
    <alias field="dep_neutsec" index="11" name=""/>
    <alias field="fo_codlant" index="12" name=""/>
    <alias field="fo_typelum" index="13" name=""/>
    <alias field="fo_marque" index="14" name=""/>
    <alias field="fo_ref" index="15" name=""/>
    <alias field="fo_classe" index="16" name=""/>
    <alias field="fo_couleur" index="17" name=""/>
    <alias field="fo_hautfeu" index="18" name=""/>
    <alias field="fo_typevas" index="19" name=""/>
    <alias field="fo_typapp" index="20" name=""/>
    <alias field="fo_famlamp" index="21" name=""/>
    <alias field="fo_puilamp" index="22" name=""/>
    <alias field="pk_descriptionsystem" index="23" name=""/>
    <alias field="id_descriptionsystem" index="24" name=""/>
    <alias field="lpk_objet" index="25" name=""/>
    <alias field="importancestrat" index="26" name=""/>
    <alias field="etatfonct" index="27" name=""/>
    <alias field="qualitegeolocXY" index="28" name=""/>
    <alias field="qualiteGeolocZ" index="29" name=""/>
    <alias field="dateGeoloc" index="30" name=""/>
    <alias field="sourceGeoloc" index="31" name=""/>
    <alias field="enservice" index="32" name=""/>
    <alias field="annee_debut_pose" index="33" name=""/>
    <alias field="annee_fin_pose" index="34" name=""/>
    <alias field="precision_pose" index="35" name=""/>
    <alias field="date_miseHorsService" index="36" name=""/>
    <alias field="parametres" index="37" name=""/>
    <alias field="listeparametres" index="38" name=""/>
    <alias field="rue_libelle" index="39" name=""/>
    <alias field="rue_libdebut" index="40" name=""/>
    <alias field="rue_libfin" index="41" name=""/>
    <alias field="rue_complement" index="42" name=""/>
    <alias field="intervenant_1" index="43" name=""/>
    <alias field="pk_objet" index="44" name=""/>
    <alias field="id_objet" index="45" name=""/>
    <alias field="lpk_revision_begin" index="46" name=""/>
    <alias field="lpk_revision_end" index="47" name=""/>
    <alias field="datetimecreation" index="48" name=""/>
    <alias field="datetimemodification" index="49" name=""/>
    <alias field="datetimedestruction" index="50" name=""/>
    <alias field="commentaire" index="51" name=""/>
    <alias field="libelle" index="52" name=""/>
    <alias field="importid" index="53" name=""/>
    <alias field="importtable" index="54" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="pk_equipement"/>
      ...
      <column width="-1" hidden="0" type="field" name="dep_nom"/>
      <column width="-1" hidden="0" type="field" name="dep_foncall"/>
      <column width="-1" hidden="0" type="field" name="dep_typprot"/>
      <column width="-1" hidden="0" type="field" name="dep_calprot"/>
      <column width="-1" hidden="0" type="field" name="dep_diffdj"/>
      <column width="-1" hidden="0" type="field" name="dep_neutsec"/>
      <column width="-1" hidden="0" type="field" name="fo_codlant"/>
      <column width="-1" hidden="0" type="field" name="fo_typelum"/>
      <column width="-1" hidden="0" type="field" name="fo_marque"/>
      <column width="-1" hidden="0" type="field" name="fo_ref"/>
      <column width="-1" hidden="0" type="field" name="fo_classe"/>
      <column width="-1" hidden="0" type="field" name="fo_couleur"/>
      <column width="-1" hidden="0" type="field" name="fo_hautfeu"/>
      <column width="-1" hidden="0" type="field" name="fo_typevas"/>
      <column width="-1" hidden="0" type="field" name="fo_typapp"/>
      <column width="-1" hidden="0" type="field" name="fo_famlamp"/>
      <column width="-1" hidden="0" type="field" name="fo_puilamp"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="pk_equipement" expression=""/>
    ...
    <default field="dep_nom" expression=""/>
    <default field="dep_foncall" expression=""/>
    <default field="dep_typprot" expression=""/>
    <default field="dep_calprot" expression=""/>
    <default field="dep_diffdj" expression=""/>
    <default field="dep_neutsec" expression=""/>
    <default field="fo_codlant" expression=""/>
    <default field="fo_typelum" expression=""/>
    <default field="fo_marque" expression=""/>
    <default field="fo_ref" expression=""/>
    <default field="fo_classe" expression=""/>
    <default field="fo_couleur" expression=""/>
    <default field="fo_hautfeu" expression=""/>
    <default field="fo_typevas" expression=""/>
    <default field="fo_typapp" expression=""/>
    <default field="fo_famlamp" expression=""/>
    <default field="fo_puilamp" expression=""/>
