...
<qgis simplifyLocal="1" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" simplifyDrawingHints="1" maxScale="0" version="3.10.6-A Coruña">
  <flags>
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="RuleRenderer">
    <rules key="{8d5e310e-9312-442e-8f40-0648b5891277}">
      <rule symbol="0" key="{6619d579-e78f-4493-9d1c-c4d5a43823de}" filter="1 &lt;= &quot;score_ENS4&quot; &lt;= 4">
        <rule symbol="1" key="{acfe3251-6daa-440d-8678-d64aee2a47d1}" filter="&quot;score_ENS4&quot; = 2"/>
        <rule symbol="2" key="{a8600e52-4d4a-4351-8ced-b657e05ab783}" filter="&quot;score_ENS4&quot; = 3"/>
        <rule symbol="3" key="{ec7c07db-0f11-47be-bdb6-c1b2a0f3a72d}" filter="&quot;score_ENS4&quot; = 4"/>
      </rule>
    ...
    <symbols>
      <symbol alpha="1" force_rhr="0" name="0" clip_to_extent="1" type="line">
        <layer locked="0" class="SimpleLine" pass="0" enabled="1">
          ...
          <prop k="line_color" v="36,202,60,255"/>
      ...
      <symbol alpha="1" force_rhr="0" name="1" clip_to_extent="1" type="line">
        <layer locked="0" class="SimpleLine" pass="0" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="242,242,32,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" fontFamily="MS Shell Dlg 2" fontCapitals="0" fontWeight="50" multilineHeight="1" fontKerning="1" fontWordSpacing="0" fontItalic="0" isExpression="1" blendMode="0" useSubstitutions="0" namedStyle="Normal" fontSize="8.25" fontUnderline="0" fieldName=" &quot;nominaldiameter&quot;  *1000" textOrientation="horizontal" fontStrikeout="0" fontLetterSpacing="0" textColor="0,0,0,255" textOpacity="1" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
        <text-buffer bufferSize="1" bufferOpacity="1" bufferJoinStyle="128" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferNoFill="0"/>
        <background shapeRotationType="0" shapeRadiiY="0" shapeJoinStyle="64" shapeSizeX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeBorderWidth="0" shapeSizeY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeBlendMode="0" shapeSizeType="0" shapeOffsetY="0" shapeBorderColor="128,128,128,255" shapeOffsetUnit="MM" shapeRotation="0" shapeFillColor="255,255,255,255" shapeOpacity="1" shapeSizeUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeRadiiX="0">
        ...
        <shadow shadowBlendMode="6" shadowDraw="0" shadowOffsetGlobal="1" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0.7" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusUnit="MM" shadowScale="100" shadowOffsetDist="1" shadowOffsetAngle="135" shadowRadius="1.5" shadowRadiusAlphaOnly="0" shadowColor="0,0,0,255" shadowUnder="0" shadowOffsetUnit="MM"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format reverseDirectionSymbol="0" wrapChar="" autoWrapLength="0" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" plussign="0" addDirectionSymbol="0" rightDirectionSymbol=">" multilineAlign="4294967295" formatNumbers="0" decimals="3" leftDirectionSymbol="&lt;"/>
      <placement placement="3" repeatDistance="0" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" rotationAngle="0" preserveRotation="1" offsetUnits="MapUnit" distUnits="MM" quadOffset="4" placementFlags="2" centroidWhole="0" yOffset="0" dist="0.5" priority="5" overrunDistance="0" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" layerType="LineGeometry" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" geometryGeneratorType="PointGeometry" xOffset="0" centroidInside="0" geometryGenerator=""/>
      <rendering obstacle="1" labelPerPart="0" displayAll="0" upsidedownLabels="0" minFeatureSize="2" maxNumLabels="2000" obstacleFactor="1" scaleMin="1" scaleMax="5000" obstacleType="0" fontMinPixelSize="3" zIndex="0" scaleVisibility="1" fontLimitPixelSize="0" fontMaxPixelSize="10000" drawLabels="1" limitNumLabels="0" mergeLines="1"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <customproperties>
    <property key="dualview/previewExpressions" value="COALESCE( &quot;TYP_RESEAU&quot;, '&lt;NULL>' )"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory labelPlacementMethod="XHeight" backgroundColor="#ffffff" opacity="1" barWidth="5" height="15" maxScaleDenominator="1e+08" rotationOffset="270" width="15" sizeScale="3x:0,0,0,0,0,0" penAlpha="255" penWidth="0" enabled="0" lineSizeType="MM" minScaleDenominator="0" penColor="#000000" lineSizeScale="3x:0,0,0,0,0,0" diagramOrientation="Up" minimumSize="0" sizeType="MM" scaleDependency="Area" scaleBasedVisibility="0" backgroundAlpha="255">
      <fontProperties description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" style=""/>
      <attribute color="#000000" label="" field=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings obstacle="0" zIndex="0" showAll="1" priority="0" placement="2" linePlacementFlags="2" dist="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="Acier" value="01" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Amiante-ciment" value="02" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Béton arme tole" value="03" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Beton arme" value="04" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Beton fibre" value="05" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Beton non arme" value="06" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Cuivre" value="07" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Fibre ciment" value="08" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Fibre de verre" value="09" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Fibrociment" value="10" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Fonte ductile" value="11" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Fonte grise" value="12" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Gres" value="13" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Maconnerie" value="14" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Meuliere" value="15" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PEBD" value="16" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PEHD annele" value="17" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PEHD lisse" value="18" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Plomb" value="19" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PP annele" value="20" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PP lisse" value="21" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PRV A" value="22" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PRV B" value="23" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PVC ancien" value="24" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PVC BO" value="25" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PVC U annele" value="26" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="PVC U lisse" value="27" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Tole galvanisee" value="28" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Autre" value="00" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Indetermine" value="99" type="QString"/>
              </Option>
            </Option>
          </Option>
        </config>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="Collecteur enterré" value="COL" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Fossé" value="FOS" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Tranchée" value="TRA" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Chemin agricole" value="CHE" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Noue" value="NOU" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Caniveau" value="CAN" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Haie" value="HAI" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Fascine" value="FAS" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Chevets" value="CHV" type="QString"/>
              </Option>
            </Option>
          </Option>
        </config>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="Bétonné" value="BET" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Revêtu" value="REV" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Enherbé" value="ENH" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Terre à nue" value="NUE" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Tranchée simple à double vidange" value="TSD" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Tranchée compose à double vidange" value="TCD" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Tranchée composée stockante" value="TCS" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Tranchée infiltrante" value="TIN" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Tranchée composée infiltrante" value="TCI" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Noue d'infiltration" value="NIN" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Noue stockante" value="NST" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Noue à double vidange" value="NDV" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Circulaire" value="CIR" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Aqueduc" value="AQU" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Ovoide" value="OVO" type="QString"/>
              </Option>
            </Option>
          </Option>
        </config>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="Gravitaire" value="1" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Force" value="2" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Sous-vide" value="3" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Autre" value="0" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Indetermine" value="99" type="QString"/>
              </Option>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="Pluvial" value="PLU" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Eaux usees" value="USE" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Unitaire" value="UNI" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Industriel" value="IND" type="QString"/>
              </Option>
            </Option>
          </Option>
        </config>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="Ruissellement diffus" value="DIF" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="En chute" value="CHU" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Régulé" value="REG" type="QString"/>
              </Option>
              <Option type="Map">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="Infiltration" value="INF" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Sous pressions" value="PRE" type="QString"/>
              </Option>
            </Option>
          </Option>
        </config>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="Transport" value="1" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Collecte" value="2" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Stockage" value="3" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Régulation" value="4" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Traitement" value="5" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Autre" value="0" type="QString"/>
              </Option>
  ...
  <defaults>
    ...
    <default expression="" field="nominaldiameter" applyOnUpdate="0"/>
    <default expression="" field="pipetype" applyOnUpdate="0"/>
    <default expression="" field="pipesubtype" applyOnUpdate="0"/>
    <default expression="" field="pipeshape" applyOnUpdate="0"/>
    <default expression="" field="height" applyOnUpdate="0"/>
    <default expression="" field="laterals" applyOnUpdate="0"/>
    <default expression="" field="flowtype" applyOnUpdate="0"/>
    <default expression="" field="elevationup" applyOnUpdate="0"/>
    <default expression="" field="elevationdown" applyOnUpdate="0"/>
    <default expression="" field="depthup" applyOnUpdate="0"/>
    <default expression="" field="depthdown" applyOnUpdate="0"/>
    ...
    <default expression="" field="beddingmaterial" applyOnUpdate="0"/>
    <default expression="" field="soiltype" applyOnUpdate="0"/>
    <default expression="" field="soilmoisture" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="id_edge" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="lpk_descriptionsystem" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="lid_resource_1" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="lid_descriptionsystem_1" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="lid_descriptionsystem_2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="material" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="nominaldiameter" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="pipetype" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="pipesubtype" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="pipeshape" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="height" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="laterals" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="flowtype" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="elevationup" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="elevationdown" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="depthup" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="depthdown" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="domain" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="location" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="accessibility" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="beddingmaterial" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="soiltype" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="soilmoisture" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="pk_descriptionsystem" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="id_descriptionsystem" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="lpk_object" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="strategicvalue" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="operational" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="structuralstate" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="operationalstate" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="dateoperationalcreation" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="dateoperationalcreationupper" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="operationaldatecreationaccuracy" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="datetimeoperationaldestruction" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="geotrackingxyquality" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="geotrackingzquality" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="geotrackingdate" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="geotrackingsource" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="parameters" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="parameterslist" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="city" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="streetname" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="streetupname" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="streetdownname" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="streetcomment" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="lid_actor_1" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="lid_actor_2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="lid_actor_3" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="lid_facility" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_1" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_3" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_4" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_5" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_6" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_7" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_8" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_9" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="float_10" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_1" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_3" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_4" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_5" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_6" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_7" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_8" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_9" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="string_10" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="networktype" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="flowconditionupstream" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="flowconditiondownstream" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="systemfunction" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="pk_object" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="id_object" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="nominaldiameter"/>
    <constraint exp="" desc="" field="pipetype"/>
    <constraint exp="" desc="" field="pipesubtype"/>
    <constraint exp="" desc="" field="pipeshape"/>
    <constraint exp="" desc="" field="height"/>
    <constraint exp="" desc="" field="laterals"/>
    <constraint exp="" desc="" field="flowtype"/>
    <constraint exp="" desc="" field="elevationup"/>
    <constraint exp="" desc="" field="elevationdown"/>
    <constraint exp="" desc="" field="depthup"/>
    <constraint exp="" desc="" field="depthdown"/>
    <constraint exp="" desc="" field="domain"/>
    <constraint exp="" desc="" field="location"/>
    <constraint exp="" desc="" field="accessibility"/>
    <constraint exp="" desc="" field="beddingmaterial"/>
    <constraint exp="" desc="" field="soiltype"/>
    <constraint exp="" desc="" field="soilmoisture"/>
    ...
    <constraint exp="" desc="" field="networktype"/>
    <constraint exp="" desc="" field="flowconditionupstream"/>
    <constraint exp="" desc="" field="flowconditiondownstream"/>
    <constraint exp="" desc="" field="systemfunction"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="lid_descriptionsystem_2" width="-1" hidden="0" type="field"/>
      ...
      <column name="pk_edge" width="-1" hidden="0" type="field"/>
      <column name="id_edge" width="-1" hidden="0" type="field"/>
      <column name="lid_resource_1" width="-1" hidden="0" type="field"/>
      <column name="material" width="-1" hidden="0" type="field"/>
      <column name="nominaldiameter" width="-1" hidden="0" type="field"/>
      <column name="pipetype" width="-1" hidden="0" type="field"/>
      <column name="pipesubtype" width="-1" hidden="0" type="field"/>
      <column name="pipeshape" width="-1" hidden="0" type="field"/>
      <column name="height" width="-1" hidden="0" type="field"/>
      <column name="laterals" width="-1" hidden="0" type="field"/>
      <column name="flowtype" width="-1" hidden="0" type="field"/>
      <column name="elevationup" width="-1" hidden="0" type="field"/>
      <column name="elevationdown" width="-1" hidden="0" type="field"/>
      <column name="depthup" width="-1" hidden="0" type="field"/>
      <column name="depthdown" width="-1" hidden="0" type="field"/>
      <column name="domain" width="-1" hidden="0" type="field"/>
      <column name="location" width="-1" hidden="0" type="field"/>
      <column name="accessibility" width="-1" hidden="0" type="field"/>
      <column name="beddingmaterial" width="-1" hidden="0" type="field"/>
      <column name="soiltype" width="-1" hidden="0" type="field"/>
      <column name="soilmoisture" width="-1" hidden="0" type="field"/>
      ...
      <column name="networktype" width="-1" hidden="0" type="field"/>
      <column name="flowconditionupstream" width="-1" hidden="0" type="field"/>
      <column name="flowconditiondownstream" width="-1" hidden="0" type="field"/>
      <column name="systemfunction" width="-1" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" name="Réseaux" columnCount="1" visibilityExpression="" showLabel="1">
