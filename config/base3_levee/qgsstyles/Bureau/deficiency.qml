...
<qgis simplifyDrawingHints="1" readOnly="0" simplifyAlgorithm="0" minScale="10000" simplifyDrawingTol="1" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyLocal="1" version="3.10.6-A Coruña" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="RuleRenderer">
    <rules key="{814f4a1d-ecf8-4ab4-af4f-b8f84c22d0bd}">
      <rule filter="&quot;lid_delivery&quot; IS NULL" key="{46d4dc6a-a06a-4631-8508-44418af852f8}">
        <rule symbol="0" filter=" $length > 0.1" key="{da70c3d1-0550-4abd-b0ab-128b4bd608e0}"/>
        <rule symbol="1" filter="ELSE" key="{eedb192d-bfdd-4126-bc08-eae364b5149f}"/>
      </rule>
      <rule filter="ELSE" key="{a0ae3bd4-f4eb-4aa7-9bb3-edd809068c30}">
        <rule symbol="2" filter=" $length > 0.1" key="{a4f69b18-4029-42ef-9f50-006552884cc2}"/>
        <rule symbol="3" filter="ELSE" key="{74ff2d8d-7cc8-4c35-9d59-17be57b0cf3c}"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol name="2" alpha="1" clip_to_extent="1" force_rhr="0" type="line">
        <layer locked="0" enabled="1" pass="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="round" k="joinstyle"/>
          <prop v="170,170,170,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="1.56" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
        ...
        <layer locked="1" enabled="1" pass="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="round" k="joinstyle"/>
          <prop v="117,117,117,255" k="line_color"/>
          <prop v="dot" k="line_style"/>
          <prop v="1.36" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol name="3" alpha="1" clip_to_extent="1" force_rhr="0" type="line">
        <layer locked="0" enabled="1" pass="1" class="MarkerLine">
          ...
          <symbol name="@3@0" alpha="1" clip_to_extent="1" force_rhr="0" type="marker">
            <layer locked="0" enabled="1" pass="0" class="SimpleMarker">
              <prop v="0" k="angle"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory labelPlacementMethod="XHeight" backgroundAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" opacity="1" penColor="#000000" maxScaleDenominator="10000" lineSizeType="MM" minimumSize="0" scaleBasedVisibility="1" rotationOffset="270" sizeScale="3x:0,0,0,0,0,0" height="15" barWidth="5" penAlpha="255" diagramOrientation="Up" backgroundColor="#ffffff" scaleDependency="Area" minScaleDenominator="0" sizeType="MM" width="15" penWidth="0" enabled="0">
      <fontProperties style="" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0"/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings showAll="1" zIndex="0" placement="2" dist="0" linePlacementFlags="18" priority="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
