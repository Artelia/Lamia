...
class BaseActorTool(AbstractLamiaFormTool):
    ...
    tooltreewidgetICONPATH = os.path.join(
        os.path.dirname(__file__), "lamia_form_actor_icon.png"
    )
    ...
    def initMainToolWidget(self):
        ...
        self.formtoolwidgetconfdictmain = {
            "actor": {
                "linkfield": "id_actor",
                "widgets": {
                    "actorname": self.toolwidgetmain.lineEdit_nom,
            ...
            "object": {"linkfield": "id_objet", "widgets": {}},
        }
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), "lamia_form_actor_ui.ui")
