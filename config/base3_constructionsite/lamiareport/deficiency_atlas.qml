...
<qgis version="2.18.21" simplifyAlgorithm="0" minimumScale="0" maximumScale="10000" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{814f4a1d-ecf8-4ab4-af4f-b8f84c22d0bd}">
      <rule filter="$id = @atlas_featureid" key="{67427770-daf1-4eb3-b079-ff21fd58789b}" symbol="0">
        <rule filter="&#xa;geom_to_wkt( end_point(  $geometry ) ) !=  &#xa;geom_to_wkt( start_point(  $geometry ))" key="{0ff5a1de-9776-4407-aed1-a98539de8e34}" symbol="1"/>
        <rule filter="&#xa;geom_to_wkt( end_point(  $geometry ) ) =  &#xa;geom_to_wkt( start_point(  $geometry ))" key="{e25165d1-dbf0-4c2d-a878-b63dbd541a6c}" symbol="2"/>
      </rule>
      <rule filter="ELSE" key="{2d26d849-fb1c-42cb-9b2a-99503fa34224}" symbol="3">
        <rule filter="&#xa;geom_to_wkt( end_point(  $geometry ) ) !=  &#xa;geom_to_wkt( start_point(  $geometry ))" key="{68761087-e019-46af-83b0-e85516f8724c}" symbol="4"/>
        <rule filter="&#xa;geom_to_wkt( end_point(  $geometry ) ) =  &#xa;geom_to_wkt( start_point(  $geometry ))" key="{f2c2cda2-e497-41c4-b4fc-411a666c850a}" symbol="5"/>
      </rule>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="1" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="18,137,34,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="3">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="53,208,66,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <aliases>
    ...
    <alias field="groupedesordre" index="5" name=""/>
    ...
    <alias field="cote" index="11" name=""/>
    <alias field="position" index="12" name=""/>
    <alias field="catdes" index="13" name=""/>
    <alias field="typedes" index="14" name=""/>
    <alias field="datecreation" index="15" name=""/>
    <alias field="datedestruction" index="16" name=""/>
    <alias field="libelle" index="17" name=""/>
    <alias field="revisionbegin" index="18" name=""/>
    <alias field="revisionend" index="19" name=""/>
  </aliases>
