...
if platform.system() == "Windows":
    ...
    pathsrc = os.path.abspath("../../")
    sys.path.insert(0, pathsrc)
    path = os.path.abspath("/usr/bin/python3")
    sys.path.insert(0, path)
...
latex_documents = [
    (master_doc, "inspec.tex", u"inspec Documentation", u"PVr", "manual"),
]
...
man_pages = [(master_doc, "inspec", u"inspec Documentation", [author], 1)]
