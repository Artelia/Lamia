...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="alttamponouvrage">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{8d79bb70-3d56-44a7-9b09-ed3642611a95}">
      <rule filter=" &quot;typeOuvrageAss&quot;  = '60' " key="{1dbda66e-9a74-48f9-931e-359c3ca31688}" symbol="0" label="Regard">
        ...
        <rule filter="&quot;typeReseau&quot; = 'UNI' " key="{bb702745-da57-47af-9f8a-e0b0ee7b54ff}" symbol="3" label="Unitaire"/>
        <rule filter="&quot;typeReseau&quot; = 'IND' " key="{ee98eb47-0dd6-4716-8f4f-8a966360e411}" symbol="4" label="Industriel"/>
      </rule>
      <rule filter=" &quot;typeOuvrageAss&quot;  = '61' " key="{da89f3f5-899c-4070-bbb0-0d08ed5e159b}" symbol="5" label="Branchement">
        <rule filter="&quot;typeReseau&quot; = 'USE' " key="{784d2d51-4a31-4b8d-be70-5cd59a64570e}" symbol="6" label="Eaux usées"/>
        <rule filter="&quot;typeReseau&quot; = 'UNI' " key="{ac6f9fb3-11f6-457b-a295-ded6e65ecbad}" symbol="7" label="Unitaire"/>
        <rule filter="&quot;typeReseau&quot; = 'PLU' " key="{9a43a2a7-1ee2-4e2d-be41-f7e57678b539}" symbol="8" label="Pluviale"/>
      </rule>
      <rule filter=" &quot;typeOuvrageAss&quot;  = '71' " key="{3b51b7a1-92a7-4db2-bf4e-f59ad1cabed0}" symbol="9" label="Grille">
        <rule filter="&quot;typeReseau&quot; = 'PLU' " key="{164298cf-da20-4dfa-9a92-96370a7dfa40}" symbol="10" label="Eaux pluviales"/>
        <rule filter="&quot;typeReseau&quot; = 'USE' " key="{d16e050e-659a-46e2-b793-58c43235df41}" symbol="11" label="Eaux Usées"/>
        <rule filter="&quot;typeReseau&quot; = 'UNI' " key="{25bb33ea-b695-4d4b-b588-975511f08ba4}" symbol="12" label="Unitaire"/>
        <rule filter="&quot;typeReseau&quot; = 'IND' " key="{226af3ae-83c3-484a-9459-d204a6afb940}" symbol="13" label="Industriel"/>
      </rule>
      <rule filter=" &quot;typeOuvrageAss&quot;  = '70' " key="{25f9f3c2-695e-4992-ab82-9f7b79884c7c}" symbol="14" label="Avaloir"/>
      <rule filter=" &quot;typeOuvrageAss&quot;  = '72' " key="{6bbcb618-908e-47cb-a66a-8da7b2a45872}" symbol="15" label="Avaloir grille"/>
      <rule filter=" &quot;typeOuvrageAss&quot;  = '10' " key="{16f48c4a-184f-494e-ae72-6bb1346cc7eb}" symbol="16" label="Poste de refoulement">
        <rule filter="&quot;typeReseau&quot; = 'PLU' " key="{5493c27f-99aa-4ee7-a978-50f23a04394d}" symbol="17" label="Eaux pluviales"/>
        <rule filter="&quot;typeReseau&quot; = 'USE' " key="{82c85b46-3db9-4533-8379-52e478563566}" symbol="18" label="Eaux Usées"/>
        <rule filter="&quot;typeReseau&quot; = 'UNI' " key="{b20cfa0c-e78c-47f2-b3ca-1390ad05cb7c}" symbol="19" label="Unitaire"/>
        <rule filter="&quot;typeReseau&quot; = 'IND' " key="{c3c17dd9-bdde-4564-838c-a47ef8eaff80}" symbol="20" label="Industriel"/>
      </rule>
      <rule filter=" &quot;typeOuvrageAss&quot;  = '21' " key="{7bf88f42-c44e-495f-b6c2-54268a333549}" symbol="21" label="DSH">
        <rule filter="&quot;typeReseau&quot; = 'PLU' " key="{2aac6cc9-91da-461c-8ecd-b4c0081d3a61}" symbol="22" label="Eaux pluviales"/>
        <rule filter="&quot;typeReseau&quot; = 'USE' " key="{c34f6ae4-5562-4008-97a5-e494691ac84a}" symbol="23" label="Eaux Usées"/>
        <rule filter="&quot;typeReseau&quot; = 'UNI' " key="{fa20e50a-81dc-40f0-a50c-8999f2d8da2a}" symbol="24" label="Unitaire"/>
        <rule filter="&quot;typeReseau&quot; = 'IND' " key="{ff69acb3-f534-4b83-9352-0d50ee4322a9}" symbol="25" label="Industriel"/>
      </rule>
      <rule filter=" &quot;typeOuvrageAss&quot;  = '74' " key="{4e19d1fe-ded8-4220-b5b1-119481512103}" symbol="26" label="Gouttière">
        <rule filter="&quot;typeReseau&quot; = 'PLU' " key="{7abf00d5-013b-44d5-987f-42fb0978366f}" symbol="27" label="Eaux pluviales"/>
        <rule filter="&quot;typeReseau&quot; = 'USE' " key="{c100c3de-24c5-4e82-b7ba-750f4d740c54}" symbol="28" label="Eaux Usées"/>
        <rule filter="&quot;typeReseau&quot; = 'UNI' " key="{dec7a18f-8e04-450a-b835-c1fc66088619}" symbol="29" label="Unitaire"/>
      </rule>
      <rule filter=" &quot;TYP_POINTS&quot; = 'Ouvrage spécial'" key="{db7fdf51-a1b2-4384-b3eb-c69746b04a12}" label="Ouvrage spécial">
        <rule filter="&quot;TYP_POINTS&quot; = 'Ouvrage spécial' and  &quot;TYP_OUV_SP&quot; = 'Chasse deau'" key="{11b0c499-186f-404a-a99a-07af955247d1}" symbol="30" label="Chasse d'eau"/>
        <rule filter="&quot;TYP_POINTS&quot; = 'Ouvrage spécial' and  &quot;TYP_OUV_SP&quot; = 'Déssableur'" key="{e15a51c6-7ab9-450c-a196-6b6b3465d8f3}" symbol="31" label="Déssableur"/>
        <rule filter="&quot;TYP_POINTS&quot; = 'Ouvrage spécial' and  &quot;TYP_OUV_SP&quot; = 'Siphon'" key="{9f9ee3e5-9b17-49a0-8a53-7a2adf6a0a8a}" symbol="32" label="Siphon"/>
        <rule filter="&quot;TYP_POINTS&quot; = 'Ouvrage spécial' and  &quot;TYP_OUV_SP&quot; = 'Déversoir'" key="{c7c51d7e-12d7-49aa-9992-16765f8f849f}" symbol="33" label="Déversoir d'orage"/>
        <rule filter=" &quot;TYP_POINTS&quot; ='Ouvrage speciale' and  &quot;TYP_OUV_SP&quot; ='Débitmètre'" key="{a5dafd06-7aa5-4bc3-889b-10e697c6be3d}" symbol="34" label="Débitmètre"/>
      </rule>
      <rule filter="Else" key="{82d65fa5-5e1e-479c-9535-ec144a68392f}" symbol="35"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Color" value="0~~1~~@symbol_color~~"/>
    <property key="labeling/decimals" value="3"/>
    <property key="labeling/displayAll" value="true"/>
    <property key="labeling/dist" value="2.2"/>
    <property key="labeling/distInMapUnits" value="false"/>
    <property key="labeling/distMapUnitScale" value="0,0,0,0,0,0"/>
    <property key="labeling/drawLabels" value="true"/>
    <property key="labeling/enabled" value="true"/>
    <property key="labeling/fieldName" value="if( &quot;typeOuvrageAss&quot; = 74,'', &quot;libelle&quot; )"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;typeOuvrageAss&quot;" sortOrder="1">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="typeOuvrageAss"/>
