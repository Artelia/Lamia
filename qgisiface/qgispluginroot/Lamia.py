...
class Lamia:
    ...
    def onClosePlugin(self, dockindex):
        ...
        self.lamiadocks[dockindex]["widget"].closingPlugin.disconnect(
            self.onClosePlugin
        )
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(self.tr(u"&Lamia"), action)
    ...
    def run(self):
        ...
        self.lamiadocks[dockindex]["widget"] = InspectiondigueDockWidget(
            qgis.utils.iface.mapCanvas(), dockorder=dockindex
        )
