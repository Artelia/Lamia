...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="typres">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="neutre">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="typcab">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="natcond">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="nbresecti">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 attr="typres" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="AER" label="Aérien"/>
      <category render="true" symbol="1" value="SOU" label="Souterrain"/>
  ...
  <aliases>
    ...
    <alias field="typres" index="6" name=""/>
    <alias field="neutre" index="7" name=""/>
    <alias field="typcab" index="8" name=""/>
    <alias field="natcond" index="9" name=""/>
    <alias field="nbresecti" index="10" name=""/>
    <alias field="pk_descriptionsystem" index="11" name=""/>
    <alias field="id_descriptionsystem" index="12" name=""/>
    <alias field="lpk_objet" index="13" name=""/>
    <alias field="importancestrat" index="14" name=""/>
    <alias field="etatfonct" index="15" name=""/>
    <alias field="qualitegeolocXY" index="16" name=""/>
    <alias field="qualiteGeolocZ" index="17" name=""/>
    <alias field="dateGeoloc" index="18" name=""/>
    <alias field="sourceGeoloc" index="19" name=""/>
    <alias field="enservice" index="20" name=""/>
    <alias field="annee_debut_pose" index="21" name=""/>
    <alias field="annee_fin_pose" index="22" name=""/>
    <alias field="precision_pose" index="23" name=""/>
    <alias field="date_miseHorsService" index="24" name=""/>
    <alias field="parametres" index="25" name=""/>
    <alias field="listeparametres" index="26" name=""/>
    <alias field="rue_libelle" index="27" name=""/>
    <alias field="rue_libdebut" index="28" name=""/>
    <alias field="rue_libfin" index="29" name=""/>
    <alias field="rue_complement" index="30" name=""/>
    <alias field="intervenant_1" index="31" name=""/>
    <alias field="pk_objet" index="32" name=""/>
    <alias field="id_objet" index="33" name=""/>
    <alias field="lpk_revision_begin" index="34" name=""/>
    <alias field="lpk_revision_end" index="35" name=""/>
    <alias field="datetimecreation" index="36" name=""/>
    <alias field="datetimemodification" index="37" name=""/>
    <alias field="datetimedestruction" index="38" name=""/>
    <alias field="commentaire" index="39" name=""/>
    <alias field="libelle" index="40" name=""/>
    <alias field="importid" index="41" name=""/>
    <alias field="importtable" index="42" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="typres"/>
      <column width="-1" hidden="0" type="field" name="neutre"/>
      <column width="-1" hidden="0" type="field" name="typcab"/>
      <column width="-1" hidden="0" type="field" name="natcond"/>
      <column width="-1" hidden="0" type="field" name="nbresecti"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="typres" expression=""/>
    <default field="neutre" expression=""/>
    <default field="typcab" expression=""/>
    <default field="natcond" expression=""/>
    <default field="nbresecti" expression=""/>
