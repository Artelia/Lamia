...
<qgis version="2.18.18" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="aubaredelargeur">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="aubaredevegherbacee">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="aubaredevegarbustive">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="aubaredevegarboree">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="aubaredecommentaire">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lk_photo">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lk_profil">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="classement" index="5" name=""/>
    <alias field="aubaredelargeur" index="6" name=""/>
    <alias field="aubaredevegherbacee" index="7" name=""/>
    <alias field="aubaredevegarbustive" index="8" name=""/>
    <alias field="aubaredevegarboree" index="9" name=""/>
    <alias field="aubaredecommentaire" index="10" name=""/>
    <alias field="lk_photo" index="11" name=""/>
    <alias field="lk_profil" index="12" name=""/>
    <alias field="lk_noeud1" index="13" name=""/>
    <alias field="lk_noeud2" index="14" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="aubaredelargeur"/>
      <column width="-1" hidden="0" type="field" name="aubaredevegherbacee"/>
      <column width="-1" hidden="0" type="field" name="aubaredevegarbustive"/>
      <column width="-1" hidden="0" type="field" name="aubaredevegarboree"/>
      <column width="-1" hidden="0" type="field" name="aubaredecommentaire"/>
      <column width="-1" hidden="0" type="field" name="lk_photo"/>
      <column width="-1" hidden="0" type="field" name="lk_profil"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="aubaredelargeur" expression=""/>
    <default field="aubaredevegherbacee" expression=""/>
    <default field="aubaredevegarbustive" expression=""/>
    <default field="aubaredevegarboree" expression=""/>
    <default field="aubaredecommentaire" expression=""/>
    <default field="lk_photo" expression=""/>
    <default field="lk_profil" expression=""/>
