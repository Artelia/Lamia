...
from .lamia_rapport_tool import AbstractRapportTool
from .lamia_photos_tool import AbstractPhotosTool
from .lamia_topographie_tool import AbstractTopographieTool
...
class AbstractMarcheTool(AbstractInspectionDigueTool):

    LOADFIRST = False
    dbasetablename = 'Marche'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None,parentwidget=None, parent=None):
        super(AbstractMarcheTool, self).__init__(dbase, dialog, linkedtreewidget,gpsutil, parentwidget, parent=parent)
    ...
    def initFieldUI(self):
        ...
        if self.userwdgfield is None:
            ...
            self.propertieswdgRAPPORT = AbstractRapportTool(dbase=self.dbase, parentwidget=self)
            self.dbasechildwdgfield.append(self.propertieswdgRAPPORT)

            self.propertieswdgPHOTO = AbstractPhotosTool(dbase=self.dbase, parentwidget=self)
            self.dbasechildwdgfield.append(self.propertieswdgPHOTO)
            self.propertieswdgTOPOGRAPHIE = AbstractTopographieTool(dbase=self.dbase, parentwidget=self)
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamia_marche_tool_ui.ui')
