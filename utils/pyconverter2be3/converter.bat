...
SET SOURCEFILE="M:\FR\BOR\VT\FLUVIAL\4352471-33-SMBVJCC_Risque_inondation_Cartillon_Castelnau\10-Cartographie\QGis\BV_Medoc.sqlite"
REM ***** ASS ***********
...
SET DESTDIR="M:\FR\BOR\VT\FLUVIAL\4352471-33-SMBVJCC_Risque_inondation_Cartillon_Castelnau\10-Cartographie\qgis3"
