...
<qgis version="3.10.0-A Coru̱a" styleCategories="Symbology|Labeling|Rendering" maxScale="0" hasScaleBasedVisibilityFlag="1" minScale="10000" simplifyMaxScale="1" simplifyLocal="1" labelsEnabled="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{814f4a1d-ecf8-4ab4-af4f-b8f84c22d0bd}">
      <rule filter=" $length > 0.1" key="{830c67d5-7aea-4bc5-8f87-a47209708db8}" symbol="0"/>
      <rule filter="ELSE" key="{3cad803e-8642-43b4-a260-2ea5d7dba0b5}" symbol="1"/>
    </rules>
    <symbols>
      ...
      <symbol name="1" force_rhr="0" alpha="1" type="line" clip_to_extent="1">
        <layer enabled="1" class="MarkerLine" locked="0" pass="1">
          ...
          <symbol name="@1@0" force_rhr="0" alpha="1" type="marker" clip_to_extent="1">
