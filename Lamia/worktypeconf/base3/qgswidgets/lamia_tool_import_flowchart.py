...
class FlowChartWidget(QDialog):
    ...
    def initUI(self):
        ...
        self.flowqlabelmessage = QLabel(QtCore.QCoreApplication.translate('base3',"Error message : /"))
    ...
    def _getDatasOfOutputTerminal(self):
        ...
        for outputkey in outputflowchart.keys():
            ...
            if len(outputres) != totallinecount:
                self.flowqlabelmessage.setText(QtCore.QCoreApplication.translate('base3',"Error message : issue with " + str(outputkey)))
                return
