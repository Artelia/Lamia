...
from ..default.lamiadefault_graphique_tool import DefaultGraphiqueTool
...
class DefaultBaseGraphiqueTool(DefaultGraphiqueTool):

    LOADFIRST = False
    dbasetablename = 'Graphique'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None,gpsutil=None, parentwidget=None, parent=None):
        super(DefaultBaseGraphiqueTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
