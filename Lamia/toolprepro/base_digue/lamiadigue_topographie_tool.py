...
from ..default.lamiadefault_topographie_tool import DefaultTopographieTool, UserUI
import os
import datetime

from .lamiadigue_pointtopo_tool import DefaultBasePointtopoTool
...
class DefaultBaseTopographieTool(DefaultTopographieTool):

    LOADFIRST = True
    dbasetablename = 'Topographie'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None,gpsutil=None, parentwidget=None, parent=None):
        super(DefaultTopographieTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
    ...
    def initFieldUI(self):
        ...
        if self.userwdgfield is None:
            ...
            self.propertieswdgPOINTTOPO= DefaultBasePointtopoTool(dbase=self.dbase,gpsutil=self.gpsutil, parentwidget=self)
