...
from ..default.lamiadefault_raster_tool import DefaultRasterTool
import os
import datetime



class DefaultBaseRasterTool(DefaultRasterTool):

    LOADFIRST = True
    dbasetablename = 'Rasters'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None,gpsutil=None, parentwidget=None, parent=None):
        super(DefaultBaseRasterTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
