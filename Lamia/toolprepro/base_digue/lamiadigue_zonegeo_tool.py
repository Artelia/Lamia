...
from ..default.lamiadefault_zonegeo_tool import DefaultZonegeoTool
import os
import datetime



class DefaultBaseZonegeoTool(DefaultZonegeoTool):

    LOADFIRST = False
    dbasetablename = 'Zonegeo'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None,parentwidget=None, parent=None):
        super(DefaultZonegeoTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
