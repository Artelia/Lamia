...
from ..default.lamiadefault_desordre_tool import DefaultDesordreTool
from .lamiadigue_observation_tool import DefaultBaseObservationTool
...
class DefaultBaseDesordreTool(DefaultDesordreTool):

    LOADFIRST = True
    dbasetablename = 'Desordre'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None, parentwidget=None, parent=None):
        super(DefaultBaseDesordreTool, self).__init__(dbase, dialog, linkedtreewidget,gpsutil, parentwidget, parent=parent)
        ...
        if self.userwdgfield is None:
            ...
            if True:
                if self.parentWidget is None :
                    ...
                    self.propertieswdgOBSERVATION = DefaultBaseObservationTool(dbase=self.dbase, parentwidget=self)
                    self.dbasechildwdgfield.append(self.propertieswdgOBSERVATION)


                self.propertieswdgOBSERVATION2 = DefaultBaseObservationTool(dbase=self.dbase, parentwidget=self)
