...
from ..default.lamiadefault_observation_tool import DefaultObservationTool
...
class DefaultBaseObservationTool(DefaultObservationTool):


    def __init__(self, dbase, dialog=None, linkedtreewidget=None,gpsutil=None, parentwidget=None, parent=None):
        super(DefaultBaseObservationTool, self).__init__(dbase, dialog, linkedtreewidget,gpsutil, parentwidget, parent=parent)
    ...
    def initFieldUI(self):
        ...
        if self.userwdgfield is None:
            ...
            if self.parentWidget is not None:
                self.propertieswdgPHOTOGRAPHIE = DefaultPhotosTool(dbase=self.dbase, parentwidget=self)
