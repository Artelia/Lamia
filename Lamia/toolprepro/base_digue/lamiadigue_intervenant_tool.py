...
from ..default.lamiadefault_intervenant_tool import DefaultIntervenantTool
import os
import datetime



class DefaultBaseIntervenantTool(DefaultIntervenantTool):

    LOADFIRST = False
    dbasetablename = 'Intervenant'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None,parentwidget=None, parent=None):
        super(DefaultBaseIntervenantTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
