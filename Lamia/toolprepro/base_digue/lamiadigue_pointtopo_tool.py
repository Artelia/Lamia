...
from ..default.lamiadefault_pointtopo_tool import DefaultPointtopoTool
import os
import qgis
...
class DefaultBasePointtopoTool(DefaultPointtopoTool):

    LOADFIRST = False
    dbasetablename = 'Pointtopo'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None,parentwidget=None, parent=None):
        super(DefaultBasePointtopoTool, self).__init__(dbase, dialog, linkedtreewidget,gpsutil, parentwidget, parent=parent)
