...
class IntervenantTool(AbstractInspectionDigueTool):
    ...
    def initTool(self):
        ...
        self.linkuserwdg = {'Intervenant': {'linkfield': 'id_intervenant',
                                              'widgets': {'nom' : self.userwdg.lineEdit_nom,
                                                          'societe': self.userwdg.lineEdit_societe,
                                                          'adresse': self.userwdg.lineEdit_adresse,
                                                          'fax': self.userwdg.lineEdit_mail,
                                                          'tel': self.userwdg.lineEdit_tel,}},
