...
class BaseDefaultGraphiqueTool(BaseGraphiqueTool):

    LOADFIRST = False
    dbasetablename = 'Graphique'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None,gpsutil=None, parentwidget=None, parent=None):
        super(BaseDefaultGraphiqueTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
