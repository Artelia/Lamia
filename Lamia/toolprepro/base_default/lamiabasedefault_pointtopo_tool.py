...
class BaseDefaultPointtopoTool(BasePointtopoTool):

    LOADFIRST = False
    dbasetablename = 'Pointtopo'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None,parentwidget=None, parent=None):
        super(BaseDefaultPointtopoTool, self).__init__(dbase, dialog, linkedtreewidget,gpsutil, parentwidget, parent=parent)
