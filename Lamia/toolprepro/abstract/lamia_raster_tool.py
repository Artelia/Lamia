...
class AbstractRasterTool(AbstractInspectionDigueTool):

    
    def __init__(self, dbase, dialog=None, linkedtreewidget=None,gpsutil=None, parentwidget=None, parent=None):
        super(AbstractRasterTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
    ...
    def initTool(self):
        ...
        # self.pickTable = None
        self.iconpath = os.path.join(os.path.dirname(__file__), 'lamia_raster_tool_icon.png')
        # ****************************************************************************************
        #properties ui
        pass
