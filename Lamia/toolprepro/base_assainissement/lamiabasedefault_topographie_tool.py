...
from ..base.lamiabase_topographie_tool import BaseTopographieTool, UserUI
import os
import datetime

from .lamiabasedefault_pointtopo_tool import BaseDefaultPointtopoTool
...
class BaseDefaultTopographieTool(BaseTopographieTool):

    LOADFIRST = True
    dbasetablename = 'Topographie'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None,gpsutil=None, parentwidget=None, parent=None):
        super(BaseDefaultTopographieTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
    ...
    def initFieldUI(self):
        ...
        if self.userwdgfield is None:
            ...
            self.propertieswdgPOINTTOPO= BaseDefaultPointtopoTool(dbase=self.dbase,gpsutil=self.gpsutil, parentwidget=self)
