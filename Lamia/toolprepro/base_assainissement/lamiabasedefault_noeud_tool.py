...
from .lamiabasedefault_desordre_tool import BaseDefaultDesordreTool
from .lamiabasedefault_equipement_tool import BaseDefaultEquipementTool




class BaseDefaultNoeudTool(BaseNoeudTool):
    ...
    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None,parentwidget=None, parent=None):
        super(BaseDefaultNoeudTool, self).__init__(dbase, dialog, linkedtreewidget,gpsutil, parentwidget, parent=parent)
    ...
    def initFieldUI(self):
        ...
        if self.userwdgfield is None:
            ...
            self.propertieswdgDesordre = BaseDefaultDesordreTool(dbase=self.dbase, gpsutil=self.gpsutil, parentwidget=self)
            ...
            self.propertieswdgEquipement = BaseDefaultEquipementTool(dbase=self.dbase, parentwidget=self)
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabasedefault_noeud_tool_ui.ui')
