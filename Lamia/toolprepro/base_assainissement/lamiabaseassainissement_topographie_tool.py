...
from .lamiabaseassainissement_pointtopo_tool import BaseAssainissementPointtopoTool
...
class BaseAssainissementTopographieTool(BaseTopographieTool):
    ...
    def __init__(self, dbase, dialog=None, linkedtreewidget=None,gpsutil=None, parentwidget=None, parent=None):
        super(BaseAssainissementTopographieTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
    ...
    def initFieldUI(self):
        ...
        if self.userwdgfield is None:
            ...
            self.propertieswdgPOINTTOPO= BaseAssainissementPointtopoTool(dbase=self.dbase,gpsutil=self.gpsutil, parentwidget=self)
