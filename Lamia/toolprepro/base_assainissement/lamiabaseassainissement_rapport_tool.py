...
from ..base.lamiabase_rapport_tool import BaseRapportTool
...
class BaseAssainissementRapportTool(BaseRapportTool):

    LOADFIRST = False
    dbasetablename = 'Rapport'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None,gpsutil=None, parentwidget=None, parent=None):
        super(BaseAssainissementRapportTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
