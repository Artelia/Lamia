...
class EclairagePublicImportTool(ImportTool):

    DBASES = ['digue','base_digue','base2_digue']

    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None,parentwidget=None, parent=None):
        super(EclairagePublicImportTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil,parentwidget, parent=parent)
