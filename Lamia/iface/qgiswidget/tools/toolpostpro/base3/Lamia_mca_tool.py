...
class McaTool(AbstractLamiaTool):
    ...
    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None, parentwidget=None, parent=None):
        super(McaTool, self).__init__(dbase, dialog, linkedtreewidget, gpsutil, parentwidget, parent=parent)
        self.amcwindow = None
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        # self.setupUi(self)
        uipath = os.path.join(os.path.dirname(__file__), 'Lamia_mca_tool.ui')
