...
from .lamiabase_levee_observation_tool import BaseLeveeObservationTool
...
class BaseLeveeDeficiencyTool(BaseDeficiencyTool):
    ...
    def initMainToolWidget(self):
        ...
        self.formtoolwidgetconfdictmain = {'deficiency' : {'linkfield' : 'id_deficiency',
                                                            'widgets' : OrderedDict([('deficiencycategory', self.toolwidgetmain.comboBox_groupedes),
                                                                                    ...
                                                                                    ('deficiencysubsubtype', self.toolwidgetmain.comboBox_sstypedes)])
                                                                        },
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabase_levee_deficiency_tool_ui.ui')
