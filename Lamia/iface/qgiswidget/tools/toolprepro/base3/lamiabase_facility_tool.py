...
class BaseFacilityTool(AbstractLamiaFormTool):
    ...
    tooltreewidgetICONPATH = os.path.join(os.path.dirname(__file__), 'lamiabase_facility_tool_icon.png')
    ...
    def initMainToolWidget(self):
        ...
        self.formtoolwidgetconfdictmain = {'facility' : {'linkfield' : 'id_facility',
                                            'widgets' : {'facilitytype': self.toolwidgetmain.comboBox_type}},
                                            'object' : {'linkfield' : 'id_object',
                                                        'widgets' : {   'name': self.toolwidgetmain.lineEdit_name,
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabase_facility_tool_ui.ui')
