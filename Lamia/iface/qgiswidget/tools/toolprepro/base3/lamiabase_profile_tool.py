...
class BaseProfileTool(AbstractLamiaFormTool):
    ...
    tooltreewidgetICONPATH = os.path.join(os.path.dirname(__file__), 'lamiabase_profile_tool_icon.svg')
    
    PARENTJOIN = {'edge' : {'colparent': 'id_descriptionsystem',
    ...
    def initMainToolWidget(self):
        ...
        self.formtoolwidgetconfdictmain = {'profile' : {'linkfield' : 'id_profile',
                                                        'widgets' : {'dateprofile': self.toolwidgetmain.dateEdit,
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabase_profile_tool_ui.ui')
