...
from .lamiabase_ud_observation_tool import BaseUrbandrainageObservationTool
...
class BaseUrbandrainageDeficiencyTool(BaseDeficiencyTool):
    ...
    def initMainToolWidget(self):
        ...
        self.propertieswdgOBSERVATION = BaseUrbandrainageObservationTool(**self.instancekwargs)
