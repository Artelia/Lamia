    ...
    def postSaveFeature(self, savedfeaturepk=None):
        if self.dbase.variante in ['CD41']:
            ...
            if self.currentFeaturePK is None :  #very new equip, not newversion
                ...
                geomtext, iddessys = self.dbase.getValuesFromPk('equipment_qgis',
                ...
                sql = "UPDATE deficiency SET deficiencycategory = 'EQP' WHERE pk_deficiency = {}".format(pkdesordre)
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabase_ud_equipment_tool_ui.ui')
        uic.loadUi(uipath, self)

class UserUI_2(QWidget):
    def __init__(self, parent=None):
        super(UserUI_2, self).__init__(parent=parent)
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabase_ud_equipment_tool_ui_CD41.ui')
        uic.loadUi(uipath, self)