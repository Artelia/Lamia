...
class BaseUrbandrainageCameraTool(BaseCameraTool):


    def __init__(self, **kwargs):
        super(BaseUrbandrainageCameraTool, self).__init__(**kwargs)

    def initMainToolWidget(self):
        super(BaseUrbandrainageCameraTool, self).initMainToolWidget()
    ...
    def postSelectFeature(self):
        ...
        global numphoto
        super(BaseUrbandrainageCameraTool, self).postSelectFeature()
...
class DefaultButtons(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabase_ud_camera_tool_defaultbuttons_ui.ui')
