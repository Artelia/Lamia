...
from Lamia.libslamia.constructionsitesubobservation.cssubobservationparser import SubObservationParser
...
class BaseConstructionsiteSubObservationTool(BaseObservationTool):
    ...
    def postSaveFeature(self, savedfeaturepk=None):
        ...
        pkobject = self.dbase.getValuesFromPk('observation_qgis',
                                             'pk_object',
                                             savedfeaturepk)
        ...
        self.mainifacewidget.qgiscanvas.layers['deficiency']['layerqgis'].triggerRepaint()



    def loadTableFeature(self):
        # get typeobservation
        sql = "SELECT observationcategory FROM Observation WHERE pk_observation = " + str(self.currentFeaturePK)
    ...
    def saveTableFeature(self, featurepk):
        ...
        #typeobservation
        sqlupdate.append("observationcategory = '" + self.toolwidgetmain.comboBox_fichetype.currentText().split(' ')[0] + "'")
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabase_cs_subobservation_tool_ui.ui')
