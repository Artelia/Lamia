...
class BaseConstructionsiteDeficiencyTool(BaseDeficiencyTool):
    ...
    tooltreewidgetSUBCAT = QtCore.QCoreApplication.translate('base3_cs','Proces verbal')
    ...
    def initMainToolWidget(self):
        ...
        if self.dbase.variante in [None, 'Lamia']:
            ...
            self.temppropertieswdgOBSERVATION = BaseObservationTool(**self.instancekwargs)
            self.temppropertieswdgOBSERVATION.TABLEFILTERFIELD = {'observationcategory': 'PVA' }
    ...
    def postSaveFeature(self, savedfeaturepk=None):
        self.formutils.createNewSubFeature(self.temppropertieswdgOBSERVATION, savedfeaturepk)
