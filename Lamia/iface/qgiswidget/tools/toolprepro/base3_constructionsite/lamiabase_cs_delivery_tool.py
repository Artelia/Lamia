...
from ..base3.lamiabase_delivery_tool import BaseDeliveryTool
...
class BaseConstructionsiteDeliveryTool(BaseDeliveryTool):
    ...
    def postSelectFeature(self):
        if self.currentFeaturePK is None:
            ...
            self.formutils.applyResultDict({'datedeliverystarting' : datecreation,
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabase_cs_delivery_tool_ui_orange.ui')
