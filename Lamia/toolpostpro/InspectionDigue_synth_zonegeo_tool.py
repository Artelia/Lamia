...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        # self.setupUi(self)
        uipath = os.path.join(os.path.dirname(__file__), 'analysedesordresTool.ui')
    ...
    def getSyntheticResults(self):
        ...
        if self.parentWidget.userwdg.comboBox_objetrequest.currentText() == 'Zone geographique':
            ...
            if 'Cst' in self.dbase.dbasetables[onlytable]['fields'][onlyfield].keys():
                dbtablewdg = self.dbase.dbasetables[onlytable]['widget']
                try:
...
class DesordreUserUI(QWidget):
    def __init__(self, parent=None):
        ...
        path = os.path.join(os.path.dirname(__file__), 'DesordreSyntheseToolUser.ui')
...
class ObservationUserUI(QWidget):
    def __init__(self, parent=None):
        ...
        path = os.path.join(os.path.dirname(__file__), 'ObservationSyntheseToolUser.ui')
        uic.loadUi(path, self)
