...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{8d79bb70-3d56-44a7-9b09-ed3642611a95}">
      <rule filter="$id = attribute(@atlas_feature,'id_noeud')" key="{a4ec33db-037a-4e18-99fd-43125199a8d2}" symbol="0">
        <rule filter=" &quot;type_ouvrage&quot;  = 'CHE' " key="{f292bec8-6575-4c47-96f4-532be757422d}" symbol="1" label="Regard"/>
        <rule filter="Else" key="{b464454f-fc6b-4a4c-8d20-64a6725ab00b}" symbol="2"/>
      </rule>
      <rule filter="ELSE" key="{3f7daf05-9147-4d40-ae05-3f81d491408e}" symbol="3">
        <rule filter=" &quot;type_ouvrage&quot;  = 'CHE' " key="{6c17946c-78ce-402e-a8a1-30f5482fc5f2}" symbol="4" label="Regard"/>
        <rule filter="Else" key="{049aac48-b0b8-45aa-9717-15771f058a04}" symbol="5"/>
      </rule>
    </rules>
    <symbols>
