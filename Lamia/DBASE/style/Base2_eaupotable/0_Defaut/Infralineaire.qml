...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="profondeur_generatrice">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="protection_catodique">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="mode_circulation">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="type_eau">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fonction_cana">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="valeur_neuf">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="nombre_compteurs">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="nb_branche">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="materiau">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="joint">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="pression_min">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="pression_max">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="precision_diam">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="precision_mat">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="cla_press">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <displayfield>lpk_descriptionsystem</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    ...
    <alias field="diametre" index="6" name=""/>
    <alias field="profondeur_generatrice" index="7" name=""/>
    <alias field="domaine" index="8" name=""/>
    <alias field="branchement" index="9" name=""/>
    <alias field="protection_catodique" index="10" name=""/>
    <alias field="mode_circulation" index="11" name=""/>
    <alias field="type_eau" index="12" name=""/>
    <alias field="fonction_cana" index="13" name=""/>
    <alias field="valeur_neuf" index="14" name=""/>
    <alias field="nombre_compteurs" index="15" name=""/>
    <alias field="nb_branche" index="16" name=""/>
    <alias field="materiau" index="17" name=""/>
    <alias field="joint" index="18" name=""/>
    <alias field="pression_min" index="19" name=""/>
    <alias field="pression_max" index="20" name=""/>
    <alias field="precision_diam" index="21" name=""/>
    <alias field="precision_mat" index="22" name=""/>
    <alias field="cla_press" index="23" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="4456526">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="profondeur_generatrice"/>
      <column width="-1" hidden="0" type="field" name="domaine"/>
      <column width="-1" hidden="0" type="field" name="branchement"/>
      <column width="-1" hidden="0" type="field" name="protection_catodique"/>
      <column width="-1" hidden="0" type="field" name="mode_circulation"/>
      <column width="-1" hidden="0" type="field" name="type_eau"/>
      <column width="-1" hidden="0" type="field" name="fonction_cana"/>
      <column width="-1" hidden="0" type="field" name="valeur_neuf"/>
      <column width="-1" hidden="0" type="field" name="nombre_compteurs"/>
      <column width="-1" hidden="0" type="field" name="nb_branche"/>
      <column width="-1" hidden="0" type="field" name="materiau"/>
      <column width="-1" hidden="0" type="field" name="joint"/>
      <column width="-1" hidden="0" type="field" name="pression_min"/>
      <column width="-1" hidden="0" type="field" name="pression_max"/>
      <column width="-1" hidden="0" type="field" name="precision_diam"/>
      <column width="-1" hidden="0" type="field" name="precision_mat"/>
      <column width="-1" hidden="0" type="field" name="cla_press"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="profondeur_generatrice" expression=""/>
    <default field="domaine" expression=""/>
    <default field="branchement" expression=""/>
    <default field="protection_catodique" expression=""/>
    <default field="mode_circulation" expression=""/>
    <default field="type_eau" expression=""/>
    <default field="fonction_cana" expression=""/>
    <default field="valeur_neuf" expression=""/>
    <default field="nombre_compteurs" expression=""/>
    <default field="nb_branche" expression=""/>
    <default field="materiau" expression=""/>
    <default field="joint" expression=""/>
    <default field="pression_min" expression=""/>
    <default field="pression_max" expression=""/>
    <default field="precision_diam" expression=""/>
    <default field="precision_mat" expression=""/>
    <default field="cla_press" expression=""/>
