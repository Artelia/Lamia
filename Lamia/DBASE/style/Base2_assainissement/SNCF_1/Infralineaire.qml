...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="diametreNominal">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="formecanalisation">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="altAmont">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="altAval">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="profamont">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <rules key="{5e78f11d-4178-4ed7-8af6-f80178c4ba25}">
      <rule filter=" &quot;branchement&quot; = 1" key="{c647d32b-b632-485f-bd3c-91150bd75a8b}" symbol="0" label="Branchement">
        <rule filter="&quot;lk_descriptionsystem1&quot; IS NOT NULL AND &quot;lk_descriptionsystem2&quot; IS NOT NULL" key="{c64b87c5-2e70-47ec-a94f-a9b46d7ca120}" symbol="1">
          ...
          <rule filter="&quot;typeReseau&quot; = 'PLU'" key="{82dfa493-6268-4546-9675-43208f1ec41e}" symbol="4" label="Eaux pluviales"/>
          <rule filter="&quot;typeReseau&quot; = 'IND'" key="{79228b2f-3bcc-41db-b9b2-7a63236519b9}" symbol="5" label="Eaux pluviales"/>
        </rule>
        <rule filter="Else" key="{766e1a38-f6d0-4e9e-9f69-8e4b0e647dbd}" symbol="6">
          <rule filter="&quot;typeReseau&quot; = 'UNI'" key="{ac74001a-939a-40a3-81ae-b50456fc484f}" symbol="7" label="Unitaire"/>
          <rule filter="&quot;typeReseau&quot; = 'PLU'" key="{0b8923db-f7e2-4297-9484-2d0d9d20b43a}" symbol="8" label="Eaux pluviales"/>
          <rule filter="&quot;typeReseau&quot; = 'IND'" key="{dbb75695-32a3-476b-9a79-86b40cd6323d}" symbol="9" label="Eaux pluviales"/>
          <rule filter="&quot;typeReseau&quot; = 'USE'" key="{5315258c-e807-43f7-9e61-ca956fc223e7}" symbol="10" label="Eaux usées"/>
        </rule>
      </rule>
      <rule filter="Else" key="{06826450-6078-4741-8f6d-022aaa3d991c}" symbol="11" label="Branchement">
        <rule filter="&quot;lk_descriptionsystem1&quot; IS NOT NULL AND &quot;lk_descriptionsystem2&quot; IS NOT NULL" key="{88663e10-e0fc-4596-9b17-73b72cdd6b17}" symbol="12">
          <rule filter="&quot;typeReseau&quot; = 'IND'" key="{dbb75695-32a3-476b-9a79-86b40cd6323d}" symbol="13" label="Eaux pluviales"/>
          <rule filter="&quot;typeReseau&quot; = 'UNI'" key="{ac74001a-939a-40a3-81ae-b50456fc484f}" symbol="14" label="Unitaire"/>
          <rule filter="&quot;typeReseau&quot; = 'USE'" key="{5315258c-e807-43f7-9e61-ca956fc223e7}" symbol="15" label="Eaux usées"/>
          <rule filter="&quot;typeReseau&quot; = 'PLU'" key="{63296647-4e1b-4afe-b24e-22e8e31ff386}" symbol="16" label="Eaux pluviales"/>
        </rule>
        <rule filter="Else" key="{33f84cfd-6977-4c2a-9cb5-fc1b120f5186}" symbol="17">
          <rule filter="&quot;typeReseau&quot; = 'IND'" key="{dbb75695-32a3-476b-9a79-86b40cd6323d}" symbol="18" label="Eaux pluviales"/>
          <rule filter="&quot;typeReseau&quot; = 'UNI'" key="{ac74001a-939a-40a3-81ae-b50456fc484f}" symbol="19" label="Unitaire"/>
          <rule filter="&quot;typeReseau&quot; = 'USE'" key="{5315258c-e807-43f7-9e61-ca956fc223e7}" symbol="20" label="Eaux usées"/>
          <rule filter="&quot;typeReseau&quot; = 'PLU'" key="{d9b6ad3e-76d5-40f9-9ef2-ce4729d62da2}" symbol="21" label="Eaux pluviales"/>
        </rule>
      </rule>
      <rule filter="Else" key="{146b5a78-5b72-4838-8cb1-ae306bc010b5}" symbol="22"/>
    </rules>
    <symbols>
      <symbol alpha="0.184314" clip_to_extent="1" type="line" name="0">
      ...
      <symbol alpha="0.145098" clip_to_extent="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="10">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="170,108,16,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="0.168627" clip_to_extent="1" type="line" name="11">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.168627" clip_to_extent="1" type="line" name="12">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="14">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="239,213,0,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.857143"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="0.176471" clip_to_extent="1" type="line" name="17">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.137255" clip_to_extent="1" type="line" name="6">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="TYP_RESEAU"/>
  ...
  <displayfield>TYP_RESEAU</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    ...
    <alias field="anPoseSup" index="10" name=""/>
    <alias field="maitreOuvrage" index="11" name=""/>
    <alias field="exploitant" index="12" name=""/>
    <alias field="enService" index="13" name=""/>
    <alias field="branchement" index="14" name=""/>
    <alias field="modeCirculation" index="15" name=""/>
    <alias field="anPoseInf" index="16" name=""/>
    <alias field="longueur" index="17" name=""/>
    <alias field="typeReseau" index="18" name=""/>
    <alias field="contCanAss" index="19" name=""/>
    <alias field="fonctionCannAss" index="20" name=""/>
    <alias field="altAmont" index="21" name=""/>
    <alias field="altAval" index="22" name=""/>
    <alias field="profamont" index="23" name=""/>
    <alias field="profaval" index="24" name=""/>
    <alias field="pk_descriptionsystem" index="25" name=""/>
    <alias field="id_descriptionsystem" index="26" name=""/>
    <alias field="lpk_objet" index="27" name=""/>
    <alias field="importancestrat" index="28" name=""/>
    <alias field="etatfonct" index="29" name=""/>
    <alias field="qualitegeolocXY" index="30" name=""/>
    <alias field="qualiteGeolocZ" index="31" name=""/>
    <alias field="dateGeoloc" index="32" name=""/>
    <alias field="sourceGeoloc" index="33" name=""/>
    <alias field="parametres" index="34" name=""/>
    <alias field="listeparametres" index="35" name=""/>
    <alias field="pk_objet" index="36" name=""/>
    <alias field="id_objet" index="37" name=""/>
    <alias field="lpk_revision_begin" index="38" name=""/>
    <alias field="lpk_revision_end" index="39" name=""/>
    <alias field="datetimecreation" index="40" name=""/>
    <alias field="datetimemodification" index="41" name=""/>
    <alias field="datetimedestruction" index="42" name=""/>
    <alias field="commentaire" index="43" name=""/>
    <alias field="libelle" index="44" name=""/>
    <alias field="importid" index="45" name=""/>
    <alias field="importtable" index="46" name=""/>
  </aliases>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Réseaux" groupBox="0" columnCount="1">
      <attributeEditorField showLabel="1" index="-1" name="TYP_RESEAU"/>
      <attributeEditorField showLabel="1" index="-1" name="NAT_RESEAU"/>
      <attributeEditorField showLabel="1" index="-1" name="TYP_ECOUL"/>
