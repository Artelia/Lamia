...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="categorie" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="RTE" label="RTE"/>
      <category render="true" symbol="1" value="OUH" label="OUH"/>
      <category render="true" symbol="2" value="OUP" label="OUP"/>
      <category render="true" symbol="3" value="RHF" label="RHF"/>
      <category render="true" symbol="4" value="RHO" label="RHO"/>
      <category render="true" symbol="5" value="OUT" label="OUT"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="200,255,1,255"/>
          <prop k="line_style" v="solid"/>
