...
<qgis version="2.18.26" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{814727a1-4b57-4adf-a4a3-c02382d4918c}">
      <rule filter=" &quot;groupedesordre&quot; ='EQP'" key="{0b55e782-696a-468e-abcc-b43abe994c64}" symbol="0" label="Equipement">
        <rule filter=" &quot;gravite&quot; = '3'" key="{40ad42d5-f31d-4b24-b7ae-93536311f62e}" symbol="1" label="3 : A traiter en urgence"/>
        <rule filter=" &quot;gravite&quot; = '2'" key="{b5585939-e298-4aab-86e1-dd98cd6c053c}" symbol="2" label="2 : A traiter à court terme (6 mois)"/>
        <rule filter=" &quot;gravite&quot; IS NULL" key="{c5f5c89b-cfd0-4d99-aeab-6cb41ce07732}" symbol="3" label="Ouvrage fonctionnel"/>
        <rule filter="ELSE" key="{961abf62-5c5f-448b-9eee-614309136a5c}" symbol="4" label="&lt;=1 : A traiter à long terme ou  à surveiller"/>
      </rule>
      <rule filter=" &quot;groupedesordre&quot; ='INF'" key="{a0a42d5e-cf75-4a57-9972-ce518eebd4d1}" symbol="5" label="Tronçons">
        <rule filter=" $area &lt;0.04" key="{e7ef9bef-1302-42f2-9d30-f32ada608d81}" symbol="6" label="Gravité">
          <rule filter=" &quot;gravite&quot; = '3'" key="{47e9adc7-08b7-4b1a-bea4-e7c45def2750}" symbol="7" label="3 : A traiter en urgence"/>
          <rule filter=" &quot;gravite&quot; = '2'" key="{dee54d3a-e9d1-4b5d-87ec-670e708c724f}" symbol="8" label="2 : A traiter à court terme (6 mois)"/>
          <rule filter="ELSE" key="{3c54702d-fe38-4a17-8a19-752fbd1b626a}" symbol="9" label="&lt;=1 : A traiter à long terme ou  à surveiller"/>
        </rule>
        <rule filter=" $area >=0.04" key="{44e839a0-6437-4f56-a081-5606122e4002}" symbol="10" label="Gravité">
          <rule filter=" &quot;gravite&quot; = '3'" key="{49a8a23e-7366-4c05-9e94-9a7a9a872f7d}" symbol="11" label="3 : A traiter en urgence"/>
          <rule filter=" &quot;gravite&quot; = '2'" key="{3c7979df-fe8b-49ed-be2e-e65108bacdf9}" symbol="12" label="2 : A traiter à court terme (6 mois)"/>
          <rule filter="ELSE" key="{63d1d1a9-7af7-42c6-b0d0-744135cc2d43}" symbol="13" label="&lt;=1 : A traiter à long terme ou  à surveiller"/>
        </rule>
      </rule>
    </rules>
    <symbols>
