...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{63a903f4-4e85-483a-8fce-65199db14525}">
      <rule filter=" &quot;type_ouvrage&quot;  = 'CHE' " key="{0c326dd8-99b6-40c6-acac-b9f8987dc406}" symbol="0"/>
      <rule filter="ELSE" key="{16a688e8-3d1f-4f30-8e53-dff5e856e2dd}" symbol="1"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="176,245,90,255"/>
  ...
  <aliases>
    ...
    <alias field="type_ouvrage" index="6" name=""/>
    <alias field="ss_type_ouv" index="7" name=""/>
    <alias field="volume" index="8" name=""/>
    <alias field="nbre_cuves" index="9" name=""/>
    <alias field="cote_sql" index="10" name=""/>
    <alias field="cote_radier" index="11" name=""/>
    <alias field="cote_trop_plein" index="12" name=""/>
    <alias field="diametre" index="13" name=""/>
    <alias field="nb_compteur" index="14" name=""/>
    <alias field="fonctionnement" index="15" name=""/>
    <alias field="h_mano_tot" index="16" name=""/>
    <alias field="profondeur" index="17" name=""/>
    <alias field="X" index="18" name=""/>
    <alias field="dX" index="19" name=""/>
    <alias field="Y" index="20" name=""/>
    <alias field="dY" index="21" name=""/>
    <alias field="Z" index="22" name=""/>
    <alias field="dZ" index="23" name=""/>
