...
from .lamiabaseeaupotable_observation_tool import BaseEaupotableObservationTool
...
class BaseEaupotableDesordreTool(BaseDesordreTool):

    LOADFIRST = True
    dbasetablename = 'Desordre'

    def __init__(self, dbase, dialog=None, linkedtreewidget=None, gpsutil=None, parentwidget=None, parent=None):
        super(BaseEaupotableDesordreTool, self).__init__(dbase, dialog, linkedtreewidget,gpsutil, parentwidget, parent=parent)
        ...
        if self.userwdgfield is None:
            ...
            self.linkuserwdgfield = {'Desordre' : {'linkfield' : 'id_desordre',
                                             'widgets' : {'groupedesordre': self.userwdgfield.comboBox_groupedes,
                                                          'type_desordre': self.userwdgfield.comboBox_typedes,
                                                          'cause_desordre': self.userwdgfield.comboBox_cause_des
                                                          }},
            ...
            if True:
                if self.parentWidget is None :
                    ...
                    self.propertieswdgOBSERVATION = BaseEaupotableObservationTool(dbase=self.dbase, parentwidget=self)
                    self.dbasechildwdgfield.append(self.propertieswdgOBSERVATION)


                self.propertieswdgOBSERVATION2 = BaseEaupotableObservationTool(dbase=self.dbase, parentwidget=self)
...
class UserUI(QWidget):
    def __init__(self, parent=None):
        ...
        uipath = os.path.join(os.path.dirname(__file__), 'lamiabaseeaupotable_desordre_tool_ui.ui')
