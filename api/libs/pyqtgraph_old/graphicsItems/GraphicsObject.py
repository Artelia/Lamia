...
"""
try:
    from qgis.PyQt.QtGui import (QGraphicsObject)
except ImportError:
...
class GraphicsObject(GraphicsItem, QtGui.QGraphicsObject):
    """
    **Bases:** :class:`GraphicsItem <pyqtgraph.graphicsItems.GraphicsItem>`, :class:`QGraphicsObject`
    ...
    def itemChange(self, change, value):
        if False:
            print(change,value, type(change),  type(value))

        if  isinstance(value, QtCore.QVariant) and str(value) == 'NULL':
            value=None
