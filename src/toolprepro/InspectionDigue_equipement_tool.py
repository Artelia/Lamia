    ...
    def initTool(self):
        ...
        self.linkuserwdg = {'Equipement' : {'linkfield' : 'id_equipement',
                                         'widgets' : {'cote': self.userwdg.comboBox_cote,
                                                      ...
                                                      'dimhori': self.userwdg.doubleSpinBox_dimhoriz,
                                                      'securite' : self.userwdg.comboBox_securite,
                                                      'commentaires': self.userwdg.textBrowser_comm}},
                            'Objet' : {'linkfield' : 'id_objet',
                                      'widgets' : {}},
                            'Descriptionsystem' : {'linkfield' : 'id_descriptionsystem',
                                      'widgets' : {}}}
        self.userwdg.comboBox_cat.currentIndexChanged.connect(self.changeCategorie)
